...
func (_m *RepositoryArticleInterface) FindArticleByID(ctx context.Context, id string) (*domain.Article, error) {
...
func (_m *RepositoryArticleInterface) StoreArticle(ctx context.Context, article *domain.Article) error {
